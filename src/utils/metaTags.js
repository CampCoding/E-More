...
export const MetaTags = ({ title, description, keywords, image, url }) => {
  ...
  const defaultUrl = 'https://e-morelms.online';
...
export const pageMetaTags = {
  ...
  about: {
    ...
    url: 'https://e-morelms.online/about'
  },
  courses: {
    ...
    url: 'https://e-morelms.online/allcourses'
  },
  contact: {
    ...
    url: 'https://e-morelms.online/contact'
  },
  login: {
    ...
    url: 'https://e-morelms.online/login'
  },
  register: {
    ...
    url: 'https://e-morelms.online/register'
  },
  profile: {
    ...
    url: 'https://e-morelms.online/profile'
  },
  cart: {
    ...
    url: 'https://e-morelms.online/cart'
  }
};
