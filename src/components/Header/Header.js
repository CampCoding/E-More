              ...
              {navigationLinks.map((link) => {
                ...
                return (
                  <motion.a
                    ...
                    href={link.path}
                    whileHover={{ scale: 1.05 }}
                    className="flex flex-row-reverse items-center space-x-reverse space-x-2 px-6 py-2 rounded-full no-underline !text-white hover:bg-white/20 text-lg font-bold tracking-wide"
                    style={{
                      fontFamily: "Cairo, Playpen Sans Arabic, sans-serif",
                    }}
                  >
                    <span className="font-bold mx-2">{link.name}</span>
