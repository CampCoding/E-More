...
const featuresData = [
  {
    title: "وقت القصة التفاعلي",
    des: "جلسات قصصية جذابة مع شخصيات متحركة ومؤثرات صوتية تبعث الحياة في القصص!",
    icon: <BookOpen color="black" />,
    color: "bg-blue-100 border-blue-300",
    iconColor: "text-blue-600"
  },
  {
    title: "ألعاب قواعد ممتعة",
    des: "تعلم القواعد من خلال الألعاب المثيرة والألغاز والأنشطة التفاعلية التي تجعل القواعد لا تُنسى.",
    icon: <Gamepad2 color="black" />,
    color: "bg-blue-100 border-blue-300",
    iconColor: "text-blue-600"
  },
  {
    title: "الصوتيات والأغاني",
  ...
  {
    title: "أنشطة المجموعات الصغيرة",
    des: "تعلم تعاوني في مجموعات صغيرة حيث يمارس الأطفال التحدث ويبنون الثقة معًا.",
  ...
  },
  {
    ...
    des: "إلهام الخيال من خلال تمارين الكتابة الإبداعية والرسم ومشاريع سرد القصص.",
       ...
       <div className="text-center mt-16">
        <div className="bg-white rounded-3xl shadow-2xl p-8 max-w-2xl mx-auto border-4 border-yellow-300">
          ...
          <p className="text-lg text-gray-600 mb-6">
            انضم إلى فصولنا المليئة بالمرح حيث يصبح كل طفل متحدثًا واثقًا بالعديد من اللغات
          </p>
          <button
            onClick={() => {
